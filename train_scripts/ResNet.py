...
class ResNetOriginal(nn.Module):
    """
    ResNet implementation based on the original paper.
    """
...
def create_resnet(num_classes=10, input_channels=1, layers=[2, 2, 2, 2]):
    """
    ...
    Returns:
        model: ResNet model
    """
    model = ResNetOriginal(ResidualBlock, layers, num_classes, input_channels)
    return model

# Create a wrapper class for backend compatibility
class ResNet(nn.Module):
    """
    ResNet wrapper class with default parameters for backend compatibility
    """
    def __init__(self, num_classes=10, input_channels=1):
        super(ResNet, self).__init__()
        # Default to ResNet-18 configuration: [2, 2, 2, 2]
        self.resnet = ResNetOriginal(ResidualBlock, [2, 2, 2, 2], num_classes, input_channels)
