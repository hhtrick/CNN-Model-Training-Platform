...
class VGG(nn.Module):
    """
    VGG implementation based on the original paper, adapted for MNIST-like datasets.
    """
    def __init__(self, num_classes=10, input_channels=1, dropout_rate=0.5):
        super(VGG, self).__init__()
        
        # VGG feature layers (similar to VGG11 configuration) - adapted for small images
        self.features = nn.Sequential(
            # Block 1
            nn.Conv2d(input_channels, 64, kernel_size=3, padding=1),  # Dynamic input channels
