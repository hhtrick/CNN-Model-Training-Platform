...
class LeNet(nn.Module):
    """
    LeNet implementation based on the original paper, adapted for various input sizes.
    """
    ...
    def forward(self, x):
        ...
        x = self.activation(self.classifier[0](x))
        x = self.activation(self.classifier[1](x))
